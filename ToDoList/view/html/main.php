...
<body>
    <div class="display">Mine, absolutely useless, made in few days without normal classes and a framework, </div>
    ...
    <span id='holder2' style='display:none'></span>
        ...
        <table class="mx-auto w-auto">
            <thead class='head'>
                <tr>
                    ...
                    <td>
                        <button type="button" id = 'add' class="btn btn-default add-button" aria-label="Left Align">
    ...
    <script src="../js/main/TaskController.js"></script>
